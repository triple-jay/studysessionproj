...
//  StudySession
//
//  Created by Christy Song on 11/15/19.
...
class SessionInfoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        addToMySessionButton = UIBarButtonItem(title: "Add", style: .plain, target: self, action: #selector(addToMySessions))
        navigationItem.rightBarButtonItem = addToMySessionButton
